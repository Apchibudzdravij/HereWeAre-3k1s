...
| Тест | Значение | Ожидаемый результат | Итог |
| :---: | :---: | :---: | :---: |
| Добавление | 50x Samsung 82" (8 QLED 8k) | 991350 | @@Неудача@@ - Ошибка: Too Many Attempts |
...
| Ввод данных карты | *валидные значения* | Успешный переход на страницу подтверждения | Неудача - 404 - нет страницы *(lol)[https://github.com/Apchibudzdravij/HereWeAre-3k1s/blob/main/T(S)S/l4/screenshots/lol2.png]* |
